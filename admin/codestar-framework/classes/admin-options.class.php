...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public function __construct( $key, $params = array() ) {
      ...
      $this->args['framework_title']=wp_get_theme()->get('Name').'<small> 主题当前版本V'.wp_get_theme()->get("Version").'</small>';
    ...
    public function add_admin_footer_text() {
          $default = '感谢您使用'.wp_get_theme()->get('Name').'<a href="'.wp_get_theme()->get('ThemeURI').'" target="_blank">Author : '.wp_get_theme()->get('Author').' </a>From <i class="fa fa-leaf"></i> ';
